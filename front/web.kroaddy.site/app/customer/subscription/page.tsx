...
export default function SubscriptionPage() {
    ...
    const plans = {
        monthly: {
            ...
            features: ["전문가 추천 요약 제공", "개별 문의/가이드 우선 응답", "최신 기능 업데이트 포함"],
        },
        yearly: {
            title: "연간 플랜",
            badge: "추천",
            price: "연 46,800원",
            note: "연간 이용",
            oldPrice: "월 기준 약 7,000원대",
            features: ["월간 플랜 혜택 전체 포함", "연간 기간 동안 할인 적용", "우선 지원 및 서비스 안정성 강화"],
        },
    };

    const active = plans[planId];
    const ctaText = planId === "monthly" ? "월간 구독 시작하기" : "연간 구독 시작하기";

    return (
        <AppLayout onLogout={logout} mobileTitle="구독 서비스">
                ...
                <header className="shrink-0 border-b border-gray-200 bg-white px-6 py-5">
                    <div className="flex items-start justify-between gap-4">
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h1 className="text-xl font-bold text-gray-900">구독 서비스</h1>
                                <p className="mt-1 text-sm text-gray-500">무료 체험 후 원하는 플랜을 선택하세요.</p>
                            </div>
                        </div>
                        <div className="flex items-start gap-2 text-xs text-gray-500">
                            <CrownIcon />
                            <span>안전한 결제 · 언제든 해지 가능</span>
                        </div>
                    </div>
                </header>
                    ...
                    <section className="rounded-3xl bg-white p-5 shadow-sm ring-1 ring-gray-200">
                        <div className="flex items-start justify-between gap-4">
                            <div className="min-w-0">
                                <div className="text-sm font-semibold text-gray-800">오늘 무료로 시작해요</div>
                                <div className="mt-1 text-xs text-gray-500">
                                    7일동안 무료 사용 후, 선택한 플랜으로 자동 전환됩니다.
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="grid grid-cols-2">
                                ...
                                >
                                    <div className="flex items-center justify-between gap-2">
                                        <div className="text-sm font-bold text-gray-900">월간 플랜</div>
                                ...
                                >
                                    <div className="flex items-center justify-between gap-2">
                                        <div className="text-sm font-bold text-gray-900">연간 플랜</div>
                        ...
                        <div className="mt-4 rounded-2xl border border-gray-200 bg-gradient-to-b from-white to-gray-50 p-4">
                            <div className="flex items-center justify-between gap-3">
                                <div>
                                    <div className="text-sm font-bold text-gray-900">선택한 플랜</div>
                                    <div className="mt-1 text-xs text-gray-500">
                                        {active.title} · {active.oldPrice ? `비교 ${active.oldPrice}` : "혜택 포함"}
                                    </div>
                                </div>
                        ...
                        <div className="mt-4 space-y-3">
                            <label className="flex items-center justify-between gap-3 rounded-2xl border border-gray-200 bg-white p-4">
                                <div className="min-w-0">
                                    <div className="text-sm font-semibold text-gray-900">서비스 이용 동의</div>
                                    <div className="mt-0.5 text-xs text-gray-500">구독 결제 및 서비스 이용을 위해 필요합니다.</div>
                                </div>
                                <input
                                    type="checkbox"
                                    checked={agree1}
                            ...
                            <label className="flex items-center justify-between gap-3 rounded-2xl border border-gray-200 bg-white p-4">
                                <div className="min-w-0">
                                    <div className="text-sm font-semibold text-gray-900">결제/과금 안내 동의</div>
                                    <div className="mt-0.5 text-xs text-gray-500">자동 전환 및 결제 주기에 대한 안내입니다.</div>
                                </div>
                                <input
                                    type="checkbox"
                                    checked={agree2}
                        ...
                        <button
                            ...
                            onClick={() => alert(`${ctaText}\n(데모 UI) 실제 결제 API 연동은 다음 단계에서 진행합니다.`)}
                        ...
                        <div className="mt-3 text-center text-[11px] leading-relaxed text-gray-500">
                            데모 화면입니다. 실제 결제/자동 전환은 운영 환경에서 연동됩니다.
                        </div>
                    </section>
                </div>
            </main>
